...
import com.example.neoticket.viewModel.sport.CreateSportTicketViewModel
import com.example.neoticket.viewModel.theater.CreateTheaterTicketViewModel
...
class ConfirmTheaterTicketSeatsFragment : BottomSheetDialogFragment() {
    private lateinit var binding: FragmentConfirmTicketSeatsBinding
    private val viewModel: CreateTheaterTicketViewModel by viewModels()
    ...
    companion object {
        fun newInstance(showTime: Int): ConfirmTheaterTicketSeatsFragment {
            val fragment = ConfirmTheaterTicketSeatsFragment()
            val args = Bundle()
            ...
            if (Util.token != null) {
                viewModel.createTicketLiveData.observe(viewLifecycleOwner, Observer { result ->
                    if (result != null) {
                        ...
                        bundle.putString("source", "theaterTicket")
